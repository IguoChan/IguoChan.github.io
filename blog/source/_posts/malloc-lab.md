...
## 1. 书本代码
其实书本上已经实现了部分的代码，我们首先将书本的代码实现，看看分数是多少？有关分数的评定，下载的文件中并没有给到，大家也可以去[traces](https://github.com/IguoChan/CSAPP-Labs/tree/main/labs/malloc-lab/traces)中拿到相关trace文件，以作评分用。
